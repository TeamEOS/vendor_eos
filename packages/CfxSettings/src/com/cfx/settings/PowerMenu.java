...
public class PowerMenu extends CFXPreferenceFragment {
	private static final String REBOOT = "cfx_power_menu_item_reboot";
	private static final String REBOOT_ADVANCED = "cfx_power_menu_item_reboot_advanced";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mRebootAdvanced = (CheckBoxPreference) findPreference(REBOOT_ADVANCED);
		mRebootAdvanced.setChecked(Settings.Secure.getInt(mResolver,
