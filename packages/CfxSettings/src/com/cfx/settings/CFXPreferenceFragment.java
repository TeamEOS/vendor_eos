 ...
 */
public class CFXPreferenceFragment extends PreferenceFragment implements DialogCreatable {
    ...
    public static class SettingsDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            if (savedInstanceState != null) {
                ...
                if (mParentFragment instanceof CFXPreferenceFragment) {
                    // restore mDialogFragment in mParentFragment
                    ((CFXPreferenceFragment) mParentFragment).mDialogFragment = this;
                }
            }
        ...
        public void onDetach() {
            ...
            if (mParentFragment instanceof CFXPreferenceFragment) {
                ...
                if (((CFXPreferenceFragment) mParentFragment).mDialogFragment == this) {
                    ((CFXPreferenceFragment) mParentFragment).mDialogFragment = null;
                }
            }
        }
    }
